...
public class manDeffendGUI : MonoBehaviour {
	...
	void OnGUI()
	{
		...
		GUI.TextArea(new Rect( 400, 10, 100, 50),"Enemy Attack Roll (he needs help)");
		...
		GUI.Label (new Rect (100, 102, 60, 60), GameDataScript.man.ToString ());
